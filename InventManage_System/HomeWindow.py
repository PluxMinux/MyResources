...
class Home(QWidget):
    ...
    def InitWindow(self):
        ...
        self.PBNewInqury.setStyleSheet("""QPushButton {border-image : url(Images/New Inquiry Button1.png);color: white;}
                                       QPushButton:hover {border-image : url(Images/New Inquiry Button.png);color: rgb(0,255,255);}""")
        ...
        self.PBOverview.setStyleSheet("""QPushButton {border-image : url(Images/PBOverview2.jpg);color: white;}
                                       QPushButton:hover {border-image : url(Images/PBOverview1.jpg);color: rgb(0,255,255);}""")
        ...
        self.PBStorage.setStyleSheet("""QPushButton {border-image : url(Images/Storage Button1.png);color: white;}
                                       QPushButton:hover {border-image : url(Images/Storage Button.png);color: rgb(0,255,255);}""")
        ...
        self.PBRecords.setStyleSheet("""QPushButton {border-image : url(Images/Records Button1.png);color: white;}
                                       QPushButton:hover {border-image : url(Images/Records Button.png);color: rgb(0,255,255);}""")
        ...
        self.PDReports.setStyleSheet("""QPushButton {border-image : url(Images/Reports Button1.png);color: white;}
                                       QPushButton:hover {border-image : url(Images/Reports Button.png);color: rgb(0,255,255);}""")
    ...
    def clickedSubmit(self):
        ...
        if ("For Deliver" in stateList):
            ...
            if(NoEmptyField1):
                ...
                connection = pymysql.connect(host='localhost',user='root',password='',db='ws_db',charset='utf8mb4',cursorclass=pymysql.cursors.DictCursor)
                with connection.cursor() as cursor:
                    cursor.execute("insert into customer_info(f_name,l_name,m_number,h_number,s_name,b_name,c_name) values (%s,%s,%s,%s,%s,%s,%s)",(f_name,l_name,m_number,h_number,s_name,b_name,c_name))	
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute('delete from today_inquiry where custo_id=1')
            cursor.execute('delete from today_inquiry where custo_id=2')
            cursor.execute('delete from today_inquiry where custo_id=3')
            cursor.execute('delete from today_inquiry where custo_id=4')
            data=cursor.execute('select custo_id,time_stamp,d_mode,t_payment,ownership,p_mode from today_inquiry order by 1 desc')
        connection.commit()
